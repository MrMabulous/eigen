...
class indexing_functor {
 ...
 public:
  typedef Matrix<typename ArgType::Scalar, RowIndexType::SizeAtCompileTime, ColIndexType::SizeAtCompileTime,
                 ArgType::Flags & RowMajorBit ? RowMajor : ColMajor, RowIndexType::MaxSizeAtCompileTime,
...
int main() {
  ...
  B = mat_indexing(A, ArrayXi::LinSpaced(13, 0, 12).unaryExpr([](int x) { return x % 4; }),
