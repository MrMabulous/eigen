...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_dawsn_interval_1(
    const Scalar& x) {
  // Rational approximation on [0, 3.25)
  const Scalar AN[] = {
    Scalar(1.13681498971755972054E-11),
    Scalar(8.49262267667473811108E-10),
    Scalar(1.94434204175553054283E-8),
    Scalar(9.53151741254484363489E-7),
    Scalar(3.07828309874913200438E-6),
    Scalar(3.52513368520288738649E-4),
    Scalar(-8.50149846724410912031E-4),
    Scalar(4.22618223005546594270E-2),
    Scalar(-9.17480371773452345351E-2),
    Scalar(9.99999999999999994612E-1),
  };
  const Scalar AD[] = {
    Scalar(2.40372073066762605484E-11),
    Scalar(1.48864681368493396752E-9),
    Scalar(5.21265281010541664570E-8),
    Scalar(1.27258478273186970203E-6),
    Scalar(2.32490249820789513991E-5),
    Scalar(3.25524741826057911661E-4),
    Scalar(3.48805814657162590916E-3),
    Scalar(2.79448531198828973716E-2),
    Scalar(1.58874241960120565368E-1),
    Scalar(5.74918629489320327824E-1),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_dawsn_interval_2(
    const Scalar& x) {
  // Rational approximation on [3.25, 6.25)
  const Scalar BN[] = {
    Scalar(5.08955156417900903354E-1),
    Scalar(-2.44754418142697847934E-1),
    Scalar(9.41512335303534411857E-2),
    Scalar(-2.18711255142039025206E-2),
    Scalar(3.66207612329569181322E-3),
    Scalar(-4.23209114460388756528E-4),
    Scalar(3.59641304793896631888E-5),
    Scalar(-2.14640351719968974225E-6),
    Scalar(9.10010780076391431042E-8),
    Scalar(-2.40274520828250956942E-9),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_dawsn_interval_3(
    const Scalar& x) {
  // Rational approximation on [6.25, 1.0e9)
  const Scalar CN[] = {
    Scalar(-5.90592860534773254987E-1),
    Scalar(6.29235242724368800674E-1),
    Scalar(-1.72858975380388136411E-1),
    Scalar(1.64837047825189632310E-2),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE
Scalar generic_dawsn(const Scalar& x) {
  const Scalar half = Scalar(0.5);
...
//
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_1(const Scalar& x) {
  /* 0 < x <= 2
   Ei(x) - EUL - ln(x) = x A(x)/B(x)
   Theoretical peak relative error 9.73e-18  */
  const Scalar A[] = {
    Scalar(-5.350447357812542947283E0),
    Scalar(2.185049168816613393830E2),
    Scalar(-4.176572384826693777058E3),
    Scalar(5.541176756393557601232E4),
    Scalar(-3.313381331178144034309E5),
    Scalar(1.592627163384945414220E6),
  };
  const Scalar B[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_2(
    const Scalar& x) {
  /* 2 <= x <= 4
   x exp(-x) Ei(x) - 1  =  1/x A6(1/x) / B6(1/x)
   Theoretical absolute error = 4.89e-17  */
  const Scalar A6[] = {
    Scalar(1.981808503259689673238E-2),
    Scalar(-1.271645625984917501326E0),
    Scalar(-2.088160335681228318920E0),
    Scalar(2.755544509187936721172E0),
    Scalar(-4.409507048701600257171E-1),
    Scalar(4.665623805935891391017E-2),
    Scalar(-1.545042679673485262580E-3),
    Scalar(7.059980605299617478514E-5),
  };
  const Scalar B6[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_3(
    const Scalar& x) {
  /* 4 <= x <= 8
     x exp(-x) Ei(x) - 1  =  1/x A5(1/x) / B5(1/x)
     Theoretical absolute error = 2.20e-17  */
  const Scalar A5[] = {
    Scalar(-1.373215375871208729803E0),
    Scalar(-7.084559133740838761406E-1),
    Scalar( 1.580806855547941010501E0),
    Scalar(-2.601500427425622944234E-1),
    Scalar( 2.994674694113713763365E-2),
    Scalar(-1.038086040188744005513E-3),
    Scalar( 4.371064420753005429514E-5),
    Scalar( 2.141783679522602903795E-6),
  };
  const Scalar B5[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_4(
    const Scalar& x) {
  /* 8 <= x <= 16
   x exp(-x) Ei(x) - 1 = 1/x R(1/x)
   Theoretical peak absolute error = 1.07e-17  */
  const Scalar A2[] = {
    Scalar(-2.106934601691916512584E0),
    Scalar(1.732733869664688041885E0),
    Scalar(-2.423619178935841904839E-1),
    Scalar(2.322724180937565842585E-2),
    Scalar(2.372880440493179832059E-4),
    Scalar(-8.343219561192552752335E-5),
    Scalar(1.363408795605250394881E-5),
    Scalar(-3.655412321999253963714E-7),
    Scalar(1.464941733975961318456E-8),
    Scalar(6.176407863710360207074E-10),
  };
  const Scalar B2[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_5(
    const Scalar& x) {
  /* 16 <= x <= 32
   x exp(-x) Ei(x) - 1  =  1/x A4(1/x) / B4(1/x)
   Theoretical absolute error = 1.22e-17  */
  const Scalar A4[] = {
    Scalar(-2.458119367674020323359E-1),
    Scalar(-1.483382253322077687183E-1),
    Scalar( 7.248291795735551591813E-2),
    Scalar(-1.348315687380940523823E-2),
    Scalar( 1.342775069788636972294E-3),
    Scalar(-7.942465637159712264564E-5),
    Scalar( 2.644179518984235952241E-6),
    Scalar(-4.239473659313765177195E-8),
  };
  const Scalar B4[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_6(
    const Scalar& x) {
  /* 32 <= x <= 64
   x exp(-x) Ei(x) - 1  =  1/x A7(1/x) / B7(1/x)
   Theoretical absolute error = 7.71e-18  */
  const Scalar A7[] = {
    Scalar(1.212561118105456670844E-1),
    Scalar(-5.823133179043894485122E-1),
    Scalar(2.348887314557016779211E-1),
    Scalar(-3.040034318113248237280E-2),
    Scalar(1.510082146865190661777E-3),
    Scalar(-2.523137095499571377122E-5),
  };
  const Scalar B7[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi_interval_7(
    const Scalar& x) {
  /* x > 64
   x exp(-x) Ei(x) - 1  =  1/x A3(1/x)/B3(1/x)
   Theoretical absolute error = 6.15e-17  */
  const Scalar A3[] = {
    Scalar(-7.657847078286127362028E-1),
    Scalar(6.886192415566705051750E-1),
    Scalar(-2.132598113545206124553E-1),
    Scalar(3.346107552384193813594E-2),
    Scalar(-3.076541477344756050249E-3),
    Scalar(1.747119316454907477380E-4),
    Scalar(-6.103711682274170530369E-6),
    Scalar(1.218032765428652199087E-7),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_expi(
    const Scalar& x) {
  ...
  if (x < two) {
    return generic_expi_interval_1<Scalar>(x);
  } else if (x < four) {
    return generic_expi_interval_2<Scalar>(x);
  } else if (x < eight) {
    return generic_expi_interval_3<Scalar>(x);
  } else if (x < sixteen) {
    return generic_expi_interval_4<Scalar>(x);
  } else if (x < thirty_two) {
    return generic_expi_interval_5<Scalar>(x);
  } else if (x < sixty_four) {
    return generic_expi_interval_6<Scalar>(x);
  }
  return generic_expi_interval_7<Scalar>(x);
}
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_fresnel_cos_interval_1(
    const Scalar& x) {
  const Scalar CN[] = {
    Scalar(-4.98843114573573548651E-8),
    Scalar(9.50428062829859605134E-6),
    Scalar(-6.45191435683965050962E-4),
    Scalar(1.88843319396703850064E-2),
    Scalar(-2.05525900955013891793E-1),
    Scalar(9.99999999999999998822E-1),
  };
  const Scalar CD[] = {
    Scalar(3.99982968972495980367E-12),
    Scalar(9.15439215774657478799E-10),
    Scalar(1.25001862479598821474E-7),
    Scalar(1.22262789024179030997E-5),
    Scalar(8.68029542941784300606E-4),
    Scalar(4.12142090722199792936E-2),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_fresnel_sin_interval_1(
    const Scalar& x) {
  const Scalar SN[] = {
    Scalar(-2.99181919401019853726E3),
    Scalar(7.08840045257738576863E5),
    Scalar(-6.29741486205862506537E7),
    Scalar(2.54890880573376359104E9),
    Scalar(-4.42979518059697779103E10),
    Scalar(3.18016297876567817986E11),
  };
  const Scalar SD[] = {
    Scalar(1.0),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_fresnel_asymp(
    const Scalar& x, bool use_sin) {
  const Scalar FN[] = {
    Scalar(4.21543555043677546506E-1),
    Scalar(1.43407919780758885261E-1),
    Scalar(1.15220955073585758835E-2),
    Scalar(3.45017939782574027900E-4),
    Scalar(4.63613749287867322088E-6),
    Scalar(3.05568983790257605827E-8),
    Scalar(1.02304514164907233465E-10),
    Scalar(1.72010743268161828879E-13),
    Scalar(1.34283276233062758925E-16),
    Scalar(3.76329711269987889006E-20),
  };
  const Scalar FD[] = {
    Scalar(1.0),
  ...
  const Scalar GN[] = {
    Scalar(5.04442073643383265887E-1),
    Scalar(1.97102833525523411709E-1),
    Scalar(1.87648584092575249293E-2),
    Scalar(6.84079380915393090172E-4),
    Scalar(1.15138826111884280931E-5),
    Scalar(9.82852443688422223854E-8),
    Scalar(4.45344415861750144738E-10),
    Scalar(1.08268041139020870318E-12),
    Scalar(1.37555460633261799868E-15),
    Scalar(8.36354435630677421531E-19),
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE
Scalar generic_fresnel_cos(const Scalar& x) {
  const Scalar zero = Scalar(0.);
  const Scalar half = Scalar(0.5);
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE
Scalar generic_fresnel_sin(const Scalar& x) {
  const Scalar zero = Scalar(0.);
  const Scalar half = Scalar(0.5);
  const Scalar a = Scalar(2.5625);
  const Scalar b = Scalar(36974.0);
...
struct fresnel_cos_impl {
  EIGEN_DEVICE_FUNC
  static EIGEN_STRONG_INLINE Scalar run(const Scalar x) {
    return generic_fresnel_cos<Scalar>(x);
  }
};
...
struct fresnel_sin_impl {
  EIGEN_DEVICE_FUNC
  static EIGEN_STRONG_INLINE Scalar run(const Scalar x) {
    return generic_fresnel_sin<Scalar>(x);
  }
};
...
template <typename Scalar>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar generic_spence(
    const Scalar& x) {
  const Scalar A[] = {
    Scalar(4.65128586073990045278E-5),
    Scalar(7.31589045238094711071E-3),
    Scalar(1.33847639578309018650E-1),
    Scalar(8.79691311754530315341E-1),
    Scalar(2.71149851196553469920E0),
    Scalar(4.25697156008121755724E0),
    Scalar(3.29771340985225106936E0),
    Scalar(1.00000000000000000126E0),
  };
  const Scalar B[] = {
    Scalar(6.90990488912553276999E-4),
    Scalar(2.54043763932544379113E-2),
    Scalar(2.82974860602568089943E-1),
    Scalar(1.41172597751831069617E0),
    Scalar(3.63800533345137075418E0),
    Scalar(5.03278880143316990390E0),
    Scalar(3.54771340985225096217E0),
    Scalar(9.99999999999999998740E-1),
  };
  const Scalar zero = Scalar(0.0);
  const Scalar one = Scalar(1.0);
...
struct spence_impl {
  EIGEN_DEVICE_FUNC
  static EIGEN_STRONG_INLINE Scalar run(const Scalar x) {
    return generic_spence<Scalar>(x);
  }
};
