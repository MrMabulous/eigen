...
void packetmath_real() {
  ...
  for (int i = 0; i < size; ++i) {
    data1[i] = internal::random<Scalar>(0.01, 1) * std::pow(Scalar(9), internal::random<Scalar>(-1, 2));
    data2[i] = internal::random<Scalar>(0.01, 1) * std::pow(Scalar(9), internal::random<Scalar>(-1, 2));
  }
  ...
  for (int i = 0; i < size; ++i) {
    data1[i] = internal::random<Scalar>(0.01, 1) * std::pow(Scalar(10), internal::random<Scalar>(-1, 2));
    data2[i] = internal::random<Scalar>(0.01, 1) * std::pow(Scalar(10), internal::random<Scalar>(-1, 2));
  }
