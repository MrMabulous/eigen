...
static void test_gen_numeric_list() {
  ...
  VERIFY(
      (is_same<typename gen_numeric_list_reversed<int, 5, 42>::type, numeric_list<int, 46, 45, 44, 43, 42> >::value));
  ...
  VERIFY(
      (is_same<typename gen_numeric_list_swapped_pair<int, 2, 44, 45, 42>::type, numeric_list<int, 42, 43> >::value));
...
static void test_concat() {
  ...
  VERIFY(
      (is_same<typename concat<numeric_list<int, 0, 0>, numeric_list<int> >::type, numeric_list<int, 0, 0> >::value));
  VERIFY(
      (is_same<typename concat<numeric_list<int>, numeric_list<int, 0, 0> >::type, numeric_list<int, 0, 0> >::value));
  ...
  VERIFY(
      (is_same<typename mconcat<type_list<dummy_a>, type_list<dummy_b> >::type, type_list<dummy_a, dummy_b> >::value));
  ...
  VERIFY(
      (is_same<typename mconcat<numeric_list<int, 0>, numeric_list<int, 1> >::type, numeric_list<int, 0, 1> >::value));
...
static void test_slice() {
  ...
  VERIFY(
      (is_same<typename take<6, tl>::type, type_list<dummy_a, dummy_a, dummy_b, dummy_b, dummy_c, dummy_c> >::value));
  ...
  VERIFY(
      (is_same<typename skip<0, tl>::type, type_list<dummy_a, dummy_a, dummy_b, dummy_b, dummy_c, dummy_c> >::value));
